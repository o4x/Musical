...
import com.o4x.musical.cast.CastHelper
import com.o4x.musical.cast.CastServer
import com.o4x.musical.extensions.*
import com.o4x.musical.model.CastStatus
import com.o4x.musical.model.MediaID
import com.o4x.musical.model.Song
import com.o4x.musical.playback.MediaSessionConnection
import com.o4x.musical.playback.players.MediaSessionCallback.Companion.ACTION_CAST_CONNECTED
import com.o4x.musical.playback.players.MediaSessionCallback.Companion.ACTION_CAST_DISCONNECTED
import com.o4x.musical.playback.players.MediaSessionCallback.Companion.ACTION_SONG_DELETED
import com.o4x.musical.playback.players.MediaSessionCallback.Companion.SONG
import com.o4x.musical.playback.players.MediaSessionCallback.Companion.SONGS_LIST
import com.o4x.musical.repository.AlbumRepository
import com.o4x.musical.repository.ArtistRepository
import com.o4x.musical.repository.PlaylistRepository
import com.o4x.musical.repository.SongRepository
import com.o4x.musical.util.Event
...
class MainViewModel(
    ...
    private fun playMedia(mediaItem: MediaBrowserCompat.MediaItem, extras: Bundle?) {
        ...
        castSession?.let { castSession ->
            ...
            val song = songsRepository.song(songID)
            val songsList = extras?.getLongArray(SONGS_LIST)
            if (songsList != null) {
                ...
                CastHelper.castSongQueue(castSession, songsRepository.songs(filteredQueue), 0)
                return
            }
