...
// Modified for Musical by Karim Abou Zeid (kabouzeid).
...
import github.o4x.m2.BuildConfig;
...
public class MediaButtonIntentReceiver extends BroadcastReceiver {
    ...
    private static void acquireWakeLockAndSendMessage(Context context, Message msg, long delay) {
        if (mWakeLock == null) {
            ...
            mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Musical headset button");
