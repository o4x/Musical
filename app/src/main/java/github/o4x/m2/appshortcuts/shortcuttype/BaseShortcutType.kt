package github.o4x.m2.appshortcuts.shortcuttype
...
import github.o4x.m2.appshortcuts.AppShortcutLauncherActivity
...
abstract class BaseShortcutType(internal var context: Context) {
    ...
    companion object {
        internal const val ID_PREFIX = "github.o4x.m2.appshortcuts.shortcuttype.id."
        val id: String
