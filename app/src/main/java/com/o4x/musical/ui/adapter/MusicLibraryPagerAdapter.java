...
import com.o4x.musical.ui.fragments.mainactivity.library.pager.ArtistsFragment;
import com.o4x.musical.ui.fragments.mainactivity.library.pager.GenresFragment;
...
public class MusicLibraryPagerAdapter extends FragmentPagerAdapter {
    ...
    public MusicLibraryPagerAdapter(@NonNull final Context context, final FragmentManager fragmentManager) {
        ...
        mContext = context;
        setCategoryInfos(PreferenceUtil.getLibraryCategoryInfos());
    }
