...
public class PlaylistMenuHelper {
    ...
    private static class SavePlaylistAsyncTask extends WeakContextAsyncTask<Playlist, String, String> {
        ...
        protected String doInBackground(Playlist... params) {
            try {
                return String.format(App.Companion.getContext().getApplicationContext().getString(R.string.saved_playlist_to), PlaylistsUtil.savePlaylist(App.Companion.getContext().getApplicationContext(), params[0]));
            } catch (IOException e) {
                e.printStackTrace();
                return String.format(App.Companion.getContext().getApplicationContext().getString(R.string.failed_to_save_playlist), e);
            }
        }
