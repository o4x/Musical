...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String PHONOGRAPH_PACKAGE_NAME = "com.o4x.musical";
    ...
    private void setupMediaSession() {
        ...
        mediaSession = new MediaSessionCompat(this, "Musical", mediaButtonReceiverComponentName, mediaButtonReceiverPendingIntent);
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.o4x.musical.PHONOGRAPH_MUSIC_SERVICE_DESTROYED"));
    }
    ...
    public void initNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N && !PreferenceUtil.isClassicNotification()) {
    ...
    private void updateMediaSessionMetaData() {
        ...
        final MediaMetadataCompat.Builder metaData = new MediaMetadataCompat.Builder()
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_ALBUM_ARTIST, song.getAlbumName())
    ...
    public void setShuffleMode(final int shuffleMode) {
        ...
        switch (shuffleMode) {
            ...
            case SHUFFLE_MODE_NONE:
                this.shuffleMode = shuffleMode;
                long currentSongId = getCurrentSong().getId();
