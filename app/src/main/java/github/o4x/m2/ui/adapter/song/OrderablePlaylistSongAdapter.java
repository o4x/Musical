package github.o4x.m2.ui.adapter.song;
...
import github.o4x.m2.ui.dialogs.RemoveFromPlaylistDialog;
...
public class OrderablePlaylistSongAdapter
  ...
  @Override
  protected void onMultipleItemAction(
      @NonNull MenuItem menuItem, @NonNull List<Song> selection) {
    int itemId = menuItem.getItemId();
    if (itemId == R.id.action_remove_from_playlist) {
      RemoveFromPlaylistDialog.create((List<PlaylistSong>) (List) selection)
  ...
  public class ViewHolder extends PlaylistSongAdapter.ViewHolder
    ...
    public ViewHolder(@NonNull View itemView) {
      ...
      itemView.setBackgroundColor(
          ColorUtil.INSTANCE.withAlpha(ColorExtKt.backgroundColor(activity), 0.8f));
    ...
    protected boolean onSongMenuItemClick(MenuItem item) {
      ...
      if (itemId == R.id.action_remove_from_playlist) {
        RemoveFromPlaylistDialog.create((PlaylistSong) getSong())
            .show(activity.getSupportFragmentManager(), "REMOVE_FROM_PLAYLIST");
        return true;
      }
