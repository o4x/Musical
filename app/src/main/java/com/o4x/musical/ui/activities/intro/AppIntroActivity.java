...
public class AppIntroActivity extends IntroActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(new SimpleSlide.Builder()
                ...
                .background(R.color.blue_grey_100)
                .backgroundDark(R.color.blue_grey_200)
        ...
        addSlide(new SimpleSlide.Builder()
                ...
                .background(R.color.deep_purple_500)
                .backgroundDark(R.color.deep_purple_600)
                .layout(R.layout.fragment_simple_slide_large_image)
                .build());
        addSlide(new SimpleSlide.Builder()
                .title(R.string.label_playing_queue)
                ...
                .backgroundDark(R.color.indigo_600)
                .layout(R.layout.fragment_simple_slide_large_image)
                .build());
    }
}
