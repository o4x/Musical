...
public class FullPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private FullPlayerFragment.Impl impl;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (Util.isLandscape(getResources())) {
            impl = new FullPlayerFragment.LandscapeImpl(this);
        } else {
            impl = new FullPlayerFragment.PortraitImpl(this);
        }
    ...
    private static abstract class BaseImpl implements FullPlayerFragment.Impl {
    ...
    @SuppressWarnings("ConstantConditions")
    private static class PortraitImpl extends FullPlayerFragment.BaseImpl {
    ...
    @SuppressWarnings("ConstantConditions")
    private static class LandscapeImpl extends FullPlayerFragment.BaseImpl {
